...
public class MvpDataFileCacheUtils {
    ...
    public static void saveToSdcard(String name, Object data) {
        MvpDataFileCacheUtils.saveEncryptedDataToFile(getSavaToSdcardName(name), data);
    }

    public static File getSavaToSdcardName(String name) {
        return new File(MvpManager.getExternalCacheDir(), name);
    }
