...
import com.w.xd.mvp.base.model.IBaseMode;
import com.w.xd.mvp.data.entity.IMvpEntity;
import com.w.xd.mvp.data.ok.MvpDataService;
import com.w.xd.mvp.data.request.MvpRequest;
import com.w.xd.mvp.data.response.MvpResponse;
import com.w.xd.mvp.utils.ParameterizedTypeImpl;
    ...
    public <T> Function<String, IMvpEntity<T>> json2Data(MvpRequest<T> request) {
        return new Function<String, IMvpEntity<T>>() {
            ...
            public IMvpEntity<T> apply(String s) throws Throwable {
                Gson gson = new Gson();
                Class aClass = Class.forName("com.w.xd.mvp.data.entity.ProxyEntity");
