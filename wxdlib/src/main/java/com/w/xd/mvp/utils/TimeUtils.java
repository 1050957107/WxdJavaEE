...
public class TimeUtils {
    ...
    public static String getStayTime(String key){
        long MineFragmentcoldStartTime = TimeUtils.getTimeCalculate(key);
        double statTime = new BigDecimal((float) MineFragmentcoldStartTime / 1000).setScale(3, BigDecimal.ROUND_HALF_UP).doubleValue();
        return String.valueOf(statTime);
    }
}