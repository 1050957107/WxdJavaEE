package com.w.xd.mvp.data.ok;

import android.content.pm.ApplicationInfo;
import android.content.pm.PackageManager;

import com.w.xd.mvp.BuildConfig;
import com.w.xd.mvp.data.ok.converter.MvpGsonConverterFactory;
            ...
            synchronized (MvpDataService.class) {
                if (mService == null) {
                    ...
                    Retrofit mRetrofit = new Retrofit.Builder()
                            ...
                            .addConverterFactory(factory == null ? new MvpGsonConverterFactory() : factory)
