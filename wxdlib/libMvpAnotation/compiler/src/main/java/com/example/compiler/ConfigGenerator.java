...
import com.w.xd.anotaion.ApiService;
import com.w.xd.anotaion.BaseUrl;
import com.w.xd.anotaion.GsonConverter;
import com.w.xd.anotaion.OkInterceptor;
...
public class ConfigGenerator implements FileGenerator {
    ...
    /**
     * mvpConfigPackageName = com.w.xd.mvp.config
     ...
     * <p>
     * <p>
     * mvpDataServicePackageName=com.w.xd.mvp.data.ok
     * mvpDataServiceClassName= MvpDataService
     * <p>
     * <p>
     * mvpApiServicePackageName=com.w.xd.mvp.data.ok
     * mvpApiServiceClassName=MvpApiService
     */
    private static final String PROPERTIES_FILE_NAME = "./wxdlib/mvp.properties";
